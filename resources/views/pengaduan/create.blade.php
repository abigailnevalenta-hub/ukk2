    ...
    <form action="{{ route('pengaduan.store') }}" method="POST" enctype="multipart/form-data">
        ...
        <div class="form-group">
            <div class="field">
                ...
                @if (auth()->user()->role === 'user')
                <input type="text" id="pelapor" name="pelapor" value="{{ Auth::user()->name }}" readonly>
                @endif

                @if (auth()->user()->role === 'admin')
                <input type="text" id="pelapor" name="pelapor" placeholder="Nama Pelapor" readonly>
                @endif
...
<script>
    ...
    // Auto-fill name based on NISN (only for admin)
    const nisnInput = document.getElementById('nisn');
    const pelaporInput = document.getElementById('pelapor');
    
    if (nisnInput && pelaporInput && pelaporInput.hasAttribute('readonly')) {
