...
<div id="userDeleteModal" class="modal">
    <div class="modal-content delete-modal-content">
        ...
        <div class="modal-body" style="text-align: center; padding: 36px 32px;">
            ...
            <h2 class="delete-title">Yakin ingin menghapus user ini?</h2>
...
<script>
    ...
    function openDeleteModal(data) {
        ...
        if (data.name || data.role) {
            ...
            infoBox.innerHTML = `
                ...
                <strong>Role:</strong> ${data.role ? data.role.charAt(0).toUpperCase() + data.role.slice(1) : '-'}<br>
    ...
    window.openUserDeleteModal = openDeleteModal;
</script>
